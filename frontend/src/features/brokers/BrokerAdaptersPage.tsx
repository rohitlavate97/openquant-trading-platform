...
const INITIAL_ADAPTERS: BrokerAdapterMetadata[] = [
  ...
  },
  {
    ...
    display_name: "Interactive Brokers TWS / Gateway",
    version: "1.0.0",
    supported_asset_classes: ["EQUITY", "FUTURE", "OPTION", "FOREX", "BOND"],
    supported_order_types: ["MARKET", "LIMIT", "STOP", "TRAIL", "OCO"],
    is_certified: false,
    is_live_trading_eligible: false,
  },
];
...
export const BrokerAdaptersPage: React.FC = () => {
  ...
  const [funds] = useState<BrokerAccountInfo>({
    account_id: "acc_main",
  ...
  const handleRunCertification = async (adapterId: string) => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        // Fallback simulate certification for demo/isolated UI
        setAdapters((prev) =>
          prev.map((a) =>
            a.adapter_id === adapterId
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-3">
        <h3 className="text-sm font-bold text-white flex items-center gap-2">
          ...
          Registered Broker Adapters & Certification States
        </h3>
              ...
              >
                ...
                <div className="pt-2 border-t border-border/60 flex items-center justify-between gap-2">
                  <Button
                    ...
                    onClick={() => setSelectedAdapter(adapter.adapter_id)}
                    className="text-xs"
                  >
